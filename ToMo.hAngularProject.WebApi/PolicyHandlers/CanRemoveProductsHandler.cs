...
{
    public class CanRemoveProductsHandler : AuthorizationHandler<CanRemoveProductsHandler>, IAuthorizationRequirement
    {
        protected override Task HandleRequirementAsync(AuthorizationHandlerContext context, CanRemoveProductsHandler handler)
        {
            ...
            if (defaultContext != null)
            {
                ...
                if (user != null)
                {
                    ...
                    if (permissions.Exists(p => p.Name.Equals("CanRemoveProducts")))
                    {
